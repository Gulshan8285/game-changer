  ...
  return (
    <PageLayout title="Refund Policy">
      <div className="text-center mb-6">
        ...
        <p className="text-zinc-400 mt-1 text-sm">Last Updated: {customContent?.refund_last_updated || 'January 2025'}</p>
      ...
      {customContent?.refund_full_text ? (
        <div className="space-y-4">
          {customContent!.refund_full_text.split('\n\n').map((section, i) => {
